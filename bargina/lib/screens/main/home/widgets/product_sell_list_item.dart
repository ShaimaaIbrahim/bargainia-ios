...
class ProductSellListItem extends StatelessWidget {
  dynamic product;
  dynamic catId;
  ProductSellListItem({Key? key, this.product, this.catId}) : super(key: key);
          ...
          children: [
            Padding(
              ...
              child: Row(
                ...
                children: [
                  // CachedNetworkmage(url: 'https://bargainia.com.sa/storage/uploads/tmpphpryoegr.png', width: 100.w, height: 50.h,),
                  // widthSpace(15.w),
                  Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      reg18Text(product.name?? 'Windows Laptop for sale', color: textColor),
                      heightSpace(10.h),
                      RichText(
                        text: TextSpan(
                          text:  'Avg Price',
            ...
            Positioned(
              ...
              child: Container(
                ...
                Navigator.of(context).push(MaterialPageRoute(builder: (context)=> SubCategoryProductsScreen(id: product.id,  catId: catId)));
              }),
            )
          ],
        )
